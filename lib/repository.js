...
const repositoryProto = {
    async initialize(repository, treeViewEl) {
        try {
            ...
            console.info('got', this.projectRoot)
    ...
    update(treeViewEl) {
        console.info(`update in tree-view-git-reporsitory`, treeViewEl)
    ...
    getProjectRoot(treeViewEl) {
        ...
        return new Promise((resolve, reject) => {
            setTimeout(() => {
                ...
                console.info('getProjectRoot', result)
                resolve(result)
            }, 1000)
        })
    },
    ...
    insertBefore(el) {
        console.info(`insert before`, el, this.branches)
...
export default async function makeTreeViewGitRepository(...args) {
    try {
        console.info(`makeTreeViewGitRepository`)
